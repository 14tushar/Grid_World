...
class PuddleWorldPrint(gym.Env):
    ...
    def reset(self):
        ...
        #np_random.uniform(low, high, size=(n,)) Sample n values randomly in range low to high.
        return self.state
